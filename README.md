...
| 提示框主题      |     默认     | 提示框主题                         |
| 使用自定义颜色    |     ❌      | 使用自定义颜色                       |
| 背景颜色       | 0x00000000 | 背景颜色                          |
| 边框顶部颜色     | 0x00000000 | 边框顶部颜色                        |
| 边框底部颜色     | 0x00000000 | 边框底部颜色                        |
| 渲染模拟盒      |     ✅      | 渲染各种方块显示的模拟盒                  |
| 更好的连接线     |     ✅      | 优化部分渲染连接线                     |
...
| 修复方块旋转菜单   |     ✅      | 修复方块旋转菜单                      |
| 更好的齿轮箱     |     ✅      | 空手时允许右键切换齿轮箱状态                |
| 更好的管道箱     |     ✅      | 空手时允许右键切换管道箱的开关状态，按住Shift切换反面 |
| 更好的底盘      |     ✅      | 空手时允许右键切换底盘状态                 |
| 始终显示滚动值    |     ✅      | 始终显示滚动值                       |
...
| Render Item Overlay                 |     ✅      | Render item information overlay                                                                               |
| Overlay Offset X                    |     0      | Overlay horizontal offset                                                                                     |
| Overlay Offset Y                    |     0      | Overlay vertical offset                                                                                       |
| Tooltip Flag Type                   |  Default   | Tooltip flag type                                                                                             |
| Tooltip Theme                       |  Default   | Tooltip theme                                                                                                 |
| Use Custom Color                    |     ❌      | Use custom color                                                                                              |
| Background Color                    | 0x00000000 | Background color                                                                                              |
| Border Top Color                    | 0x00000000 | Border top color                                                                                              |
| Border Bottom Color                 | 0x00000000 | Border bottom color                                                                                           |
...
| Fix Rotation Menu                   |     ✅      | Fix block rotation menu                                                                                       |
| Better Encased Cogwheel             |     ✅      | Allow right-clicking to toggle encased cogwheel state when empty-handed                                       |
...
| Better Chassis                      |     ✅      | Allow right-clicking to toggle chassis state when empty-handed                                                |
| Always Show Scroll Value            |     ✅      | Always show scroll value                                                                                      |
