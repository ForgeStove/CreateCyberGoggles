...
public class CCG implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		HudElementRegistry.addLast(getCCGRes("tooltip_overlay"), TooltipOverlay::renderOverlay);
		HudElementRegistry.addLast(getCCGRes("tip_overlay"), TipOverlay::renderOverlay);
