...
import com.zurrtum.create.foundation.utility.*;
...
public abstract class ClientSchematicLoaderMixin implements Self<ClientSchematicLoader> {
	@ModifyArg(
		...
		value = "INVOKE",
		target = "Lcom/zurrtum/create/infrastructure/packet/c2s/SchematicUploadPacket;begin(Ljava/lang/String;J)"
			+ "Lcom/zurrtum/create/infrastructure/packet/c2s/SchematicUploadPacket;"
	), index = 0
	)
	...
	@ModifyArg(
		...
		value = "INVOKE",
		target = "Lcom/zurrtum/create/infrastructure/packet/c2s/SchematicUploadPacket;write(Ljava/lang/String;[B)"
			+ "Lcom/zurrtum/create/infrastructure/packet/c2s/SchematicUploadPacket;"
	), index = 0
	)
	...
	@ModifyArg(
		...
		value = "INVOKE",
		target = "Lcom/zurrtum/create/infrastructure/packet/c2s/SchematicUploadPacket;finish(Ljava/lang/String;)"
			+ "Lcom/zurrtum/create/infrastructure/packet/c2s/SchematicUploadPacket;"
	), index = 0
	)
