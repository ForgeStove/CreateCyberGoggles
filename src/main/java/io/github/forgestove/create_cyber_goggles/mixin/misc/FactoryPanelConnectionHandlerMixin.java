...
public abstract class FactoryPanelConnectionHandlerMixin {
	...
	@Inject(
		...
		value = "INVOKE",
		target = "Lcom/zurrtum/create/content/logistics/factoryBoard/FactoryPanelBlock;connectedDirection"
	...
	@WrapMethod(
		method = "checkForIssues(Lcom/zurrtum/create/content/logistics/factoryBoard/ServerFactoryPanelBehaviour;"
			+ "Lcom/zurrtum/create/content/logistics/factoryBoard/ServerFactoryPanelBehaviour;)Ljava/lang/String;"
	)
	private static String checkForIssues(ServerFactoryPanelBehaviour from, ServerFactoryPanelBehaviour to, Operation<String> original) {
		if (!CCG.config.goggles.betterFactoryGauge) return original.call(from, to);
		return null;
	}
	@WrapMethod(
		method = "checkForIssues(Lcom/zurrtum/create/content/logistics/factoryBoard/ServerFactoryPanelBehaviour;"
			+ "Lcom/zurrtum/create/content/logistics/factoryBoard/FactoryPanelSupportBehaviour;)Ljava/lang/String;"
	)
	private static String checkForIssues(ServerFactoryPanelBehaviour from, FactoryPanelSupportBehaviour to, Operation<String> original) {
		if (!CCG.config.goggles.betterFactoryGauge) return original.call(from, to);
		return null;
	}
}
